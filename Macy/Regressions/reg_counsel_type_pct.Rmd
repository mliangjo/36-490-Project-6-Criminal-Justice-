...
reg_plots <- function(full_pct_df_STATE, base_vals, state, lm_pd, lm_p, lm_ca, lm_sr) {  
  ...
  ggplot(plot_df, aes(x = Unemployment.Rate, y = fit)) +
    ...
    labs(
      ...
      x = "Unemployment Rate",
      y = "Predicted Percent Counsel Type"
    ) +
...
reg_plots(full_pct_df_PA, base_vals_PA, "Pennsylvania", lm_pd_PA, lm_p_PA, lm_ca_PA, lm_sr_PA)
reg_plots(full_pct_df_OR, base_vals_OR, "Oregon", lm_pd_OR, lm_p_OR, lm_ca_OR, lm_sr_OR)
reg_plots(full_pct_df_FL, base_vals_FL, "Florida", lm_pd_FL, lm_p_FL, lm_ca_FL, lm_sr_FL)
```
