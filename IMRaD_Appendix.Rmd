...
```
\begin{center}
\textbf{Figure A.3.1:} Conviction Rate Regression Results by Attorney Type (Pennsylvania)
\end{center}

Figure A.3.1 shows the regression results for conviction rates across the four attorney types in Pennsylvania. Overall, the explanatory variables show different patterns of association by attorney type.
