...
# CSS to highlight significant coefficients (rows where stargazer adds * markers)
cat('
<style>
  /* Bold and gold-highlight significant coefficient rows in stargazer HTML tables */
  table.stargazer tr td:first-child {
    white-space: nowrap;
  }
  .sig-highlight {
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    // Find all stargazer tables and highlight rows with significance stars
    document.querySelectorAll("table.stargazer").forEach(function(tbl) {
...
# highlight_sig_cells <- function(html_path) {
#   html <- paste(readLines(html_path, warn = FALSE), collapse = "\n")
#   
#   # Bold + highlight only the individual <td> cells containing significance stars
#   # Matches: <td>-0.170<sup>*</sup></td>  or  <td>3.396<sup>**</sup></td> etc.
#   html <- gsub(
#     "(<td)([^>]*>)([^<]*<sup>\\*+<\\/sup>)",
#     "\\1 style='background-color:#ffd700;font-weight:bold;'\\2\\3",
#     html
#   )
#   
#   writeLines(strsplit(html, "\n")[[1]], html_path)
#   message("Highlighted: ", html_path)
# }
# 
...
#   )
#   
#   highlight_sig_cells(out_path)
# }
# 
# save_cr_regr_table("PA", lm_pd_PA, lm_p_PA, lm_ca_PA, lm_sr_PA, covar_labels_PA, "Pennsylvania")
# save_cr_regr_table("OR", lm_pd_OR, lm_p_OR, lm_ca_OR, lm_sr_OR, covar_labels_OR, "Oregon")
# save_cr_regr_table("FL", lm_pd_FL, lm_p_FL, lm_ca_FL, lm_sr_FL, covar_labels_FL, "Florida")
```
